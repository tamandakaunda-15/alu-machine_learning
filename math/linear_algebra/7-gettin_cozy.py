...
"""
This module provides a function to concatenate two 2D matrices along the given axis.
"""
...
def cat_matrices2D(mat1, mat2, axis=0):
    ...
    Args:
        ...
        axis (int, optional): The axis along which to concatenate (0 for rows, 1 for columns).
